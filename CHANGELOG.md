...
### Changes
- fix: improve npm authentication in GitHub Actions workflow (c7a8b05)

### Installation
```bash
npm install -g @bobmatnyc/ai-code-review@4.4.10
```
...
### Changes
- chore: update build number and version files (c390571)
- fix: make pre-release check more lenient with linting warnings (2a20aa8)
- feat: add comprehensive automated release system (2299575)

### Installation
```bash
npm install -g @bobmatnyc/ai-code-review@4.4.7
```
