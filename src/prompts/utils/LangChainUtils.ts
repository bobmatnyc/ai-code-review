    ...
    switch (reviewType) {
      ...
      case 'unused-code':
        ...
        schema = z.object({
          ...
          unusedFiles: z.array(tracedUnusedElementSchema).describe('Files that are never imported or used'),
          unusedFunctions: z.array(tracedUnusedElementSchema).describe('Functions that are never called'),
          unusedClasses: z.array(tracedUnusedElementSchema).describe('Classes that are never instantiated'),
          unusedTypesAndInterfaces: z.array(tracedUnusedElementSchema).describe('Types and interfaces that are never used'),
          deadCodeBranches: z.array(tracedUnusedElementSchema).describe('Code branches that can never execute'),
          unusedVariablesAndImports: z.array(tracedUnusedElementSchema).describe('Variables and imports that are never used'),
