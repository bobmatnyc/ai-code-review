...
import { getQuickFixesReviewFormatInstructions, quickFixesReviewParser } from '../schemas/quick-fixes-schema';
...
3. No error handling for fetch operation
  ...
  const fewShotPromptTemplate = new FewShotPromptTemplate({
    prefix: "You are a TypeScript expert analyzing code for quick fixes. Here are some examples of common issues and their analysis:",
    examples,
    examplePrompt: exampleTemplate,
    suffix: "Now, analyze the following TypeScript code for quick fixes, using the same structured approach as in the examples:\n\nCode to analyze:\n```typescript\n{CODE}\n```\n\n{{SCHEMA_INSTRUCTIONS}}",
  ...
  const formattedStandardPrompt = await standardTemplate.format({
    ...
    LANGUAGE: 'TypeScript',
    SCHEMA_INSTRUCTIONS: formatInstructions,
    LANGUAGE_INSTRUCTIONS: 'This code is written in TypeScript. Please provide language-specific advice for quick improvements.'
  });
  ...
  return {
    ...
    exampleStructuredOutput: {
      highPriorityIssues: [
        {
          ...
          suggestedFix: {
            ...
            explanation: "Adding the correct type annotation ensures type safety throughout the component."
          },
          impact: "Prevents potential runtime errors and improves developer experience with better IntelliSense.",
          effort: 1,
          priority: "high",
          category: "typing",
      ...
      lowPriorityIssues: [
        {
          ...
          suggestedFix: {
            ...
            explanation: "Displaying the actual error message helps with debugging and provides more context to users."
          },
      ...
      summary: "The code has several type safety issues, potential bugs, and areas for improvement in error handling and user experience.",
      recommendations: [
      ...
      recommendedTools: [
        ...
        {
          tool: "React Query",
          description: "Data fetching library for React that handles loading, error, and caching states",
