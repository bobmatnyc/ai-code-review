...
const MOCK_DATA: Record<string, DependencySecurityInfo> = {
  ...
  'django': {
    ...
    vulnerabilities: [
      {
        description: 'Django 2.2 before 2.2.24 has a potential directory traversal via django.contrib.admindocs.',
        severity: 'medium',
  ...
  'symfony/http-foundation': {
    ...
    vulnerabilities: [
      {
        description: 'In Symfony HttpFoundation before 4.4.7, 5.0.7, a vulnerability exists where client-sent headers are trusted and can be leveraged for cache poisoning.',
        severity: 'medium',
