 ...
 */
export async function saveRemovalScript(reviewResult: ReviewResult, outputDir: string): Promise<string | null> {
  try {
    ...
    await fs.writeFile(scriptPath, reviewResult.metadata.removalScript, { mode: 0o755 }); // Make it executable
